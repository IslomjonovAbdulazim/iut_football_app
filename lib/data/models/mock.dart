...
class MockData {
  ...
  static final List<MatchModel> sampleMatches = [
    MatchModel(
      ...
      gameStarted: true,
      additionalTimeForFirstHalf: 2,
      additionalTimeForSecondHalf: 3,
      title: 'Round 1',
      leagueId: 1,
    ),
    MatchModel(
      ...
      isSecondHalfFinished: true,
      gameStarted: true,
      additionalTimeForFirstHalf: 1,
      additionalTimeForSecondHalf: 2,
      title: 'Round 1',
      leagueId: 1,
    ),
    MatchModel(
    ...
    MatchModel(
      ...
      gameStarted: false,
      additionalTimeForFirstHalf: 0,
      additionalTimeForSecondHalf: 0,
      title: 'Round 2',
      leagueId: 1,
    ),
    MatchModel(
